...
const STATUS_MAP = {
  ...
  "od-completed": { bg: TOKENS.successBg, fg: TOKENS.success,  label: "OD Completed" },
  "od-active":    { bg: TOKENS.blueBg,    fg: TOKENS.blue,     label: "OD Active" },
  "od-upcoming":  { bg: TOKENS.warningBg, fg: TOKENS.warning,  label: "OD Upcoming" },
